      ...
      <div className="relative">
        ...
        <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-transparent backdrop-blur-2xl shadow-lg px-4">
          <div className="flex-auto p-6">
            ...
            <h4 className="mb-2 font-medium text-gray-100 xl:text-xl">
              Welcome to futurism!
            </h4>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mb-4">
              <div className="mb-2">
                ...
                <div className="relative">
                  <input
                    type="text"
                    className="block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 pl-10 text-sm outline-none focus:border-indigo-500 bg-transparent focus:text-gray-200 focus:shadow"
                    id="email"
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 h-3 w-3 text-gray-500"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
