...
const Contact = () => {
  return (
    <div>
        <Navbar />
        <div className="sm:p-10 mt-16 py-16 my-auto">
    ...
    <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
      <div className="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li className="mb-6 flex items-start text-left">
            ...
            <div>
              <a className="cursor-pointer font-serif text-base md:text-lg" href="#">Epiq@gmail.com</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <a className="cursor-pointer font-serif text-base md:text-lg" href="#">Epiq.real</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <p className="font-serif text-base md:text-lg">Epiq</p>
      ...
      <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        ...
        <form action="">
          ...
          <textarea className="mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black" id="" placeholder="Question" name="question"></textarea>
